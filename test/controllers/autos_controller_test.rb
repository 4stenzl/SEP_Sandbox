...
class AutosControllerTest < ActionController::TestCase
  ...
  test "should create auto" do
    assert_difference('Auto.count') do
      post :create, auto: { anzahl_sitze: @auto.anzahl_sitze, farbe: @auto.farbe, gekauft: @auto.gekauft }
    end
  ...
  test "should update auto" do
    patch :update, id: @auto, auto: { anzahl_sitze: @auto.anzahl_sitze, farbe: @auto.farbe, gekauft: @auto.gekauft }
    assert_redirected_to auto_path(assigns(:auto))
  end
